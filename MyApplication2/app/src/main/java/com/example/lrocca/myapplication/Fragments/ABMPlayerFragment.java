...
public class ABMPlayerFragment extends Fragment {
    ...
    private static final String PLAYERHABILITY = "hability";
  ...
  //     params.addRule(RelativeLayout.ABOVE, R.id.lvPlayers);   //<----este va
    ...
    //    params.setMargins(0,0,0,600);  //545 es la posta
        params.setMargins(0,0,0,545);         //540              //<----este va
    ...
    public void onViewCreated(View rootView, Bundle savedInstanceState) {
        ...
        if (id!=-1)this.modify(new Jugador(name,String.valueOf(hability),id));
    }
...
/*
    ...
    public static ABMPlayerFragment newInstance(Jugador j){
        ...
        bundle.putString(PLAYERNAME, j.getName());
        bundle.putInt(PLAYERHABILITY, j.getHability());
        bundle.putInt(PLAYERID, j.getId());
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.hability = (getArguments() != null) ? getArguments().getInt(PLAYERHABILITY)
                : 0;
        this.name = (getArguments() != null) ? getArguments().getString(PLAYERNAME)
                : "";
        this.id = (getArguments() != null) ? getArguments().getInt(PLAYERID)
                : -1;
    }
}
